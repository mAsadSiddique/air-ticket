    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "[&:has([aria-selected].day-outside)]:bg-primary/5 first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md"
        ),
        day_button: cn(
        ...
        today: "bg-accent/40 text-accent-foreground rounded-md",
        outside:
